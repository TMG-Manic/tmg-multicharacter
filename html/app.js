        ...
        methods: {
            click_character: function (idx, type) {
                ...
                if (this.characters[idx] !== undefined) {
                    axios.post("https://tmg-multicharacter/cDataPed", {
            ...
            delete_character: function () {
                if (this.show.delete) {
                    this.show.delete = false;
                    axios.post("https://tmg-multicharacter/removeCharacter", {
            ...
            play_character: function () {
                if (this.selectedCharacter !== -1) {
                    ...
                    if (data !== undefined) {
                        axios.post("https://tmg-multicharacter/selectCharacter", {
                            cData: data,
                        });
                        setTimeout(() => {
                            this.show.characters = false;
            ...
            create_character: function () {
                ...
                if (validationResult.isValid) {
                    ...
                    axios.post("https://tmg-multicharacter/createNewCharacter", {
                        firstname: registerData.firstname,
                        lastname: registerData.lastname,
                        nationality: registerData.nationality,
                ...
                switch (data.action) {
                    case "ui":
                        ...
                        if (data.toggle) {
                            ...
                            setTimeout(() => {
                                axios.post("https://tmg-multicharacter/setupCharacters");
                                setTimeout(() => {
                                    ...
                                    this.show.characters = true;
                                    axios.post("https://tmg-multicharacter/removeBlur");
                                }, 2000);
                            }, 2000);
                        }
                        break;
